define([
  ...
  return {
    ...
    describe: _.constant("!LOC:Omega 轨道炮升级 — 为 Omega 加装 Artemis 磁轨炮，威力 ×3，可攻击地面/轨道/海上目标。"),
    ...
    buff: function (inventory) {
      ...
      inventory.addMods([
        { file: gwoUnit.omega, path: "tools", op: "push", value: { spec_id: gwoUnit.artemisWeapon, aim_bone: "bone_root", record_index: -1, fire_event: "fired", muzzle_bone: "bone_root" } },
        { file: gwoUnit.omega, path: "tools.5.spec_id", op: "tag" },
